...
<body>
    <div class='container-fluid'>
        <div class='row'>
            <div class='col-md-12'>
                <span>
                    <h3>Controle da Fita de LED</h3><span>
                        <div class='row'>
                            <div class='col-md-4'>
                                <h4 class='text-left'>Palette Choosen
                                    <span class='badge'>
                                        <td><span id='choosenPalette'>NA</span></td>
                                    </span>
                                </h4>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='col-md-12'>
                                <div class="btn-group" role="group">
                                    ...
                                    <button type='button' onclick='setPalette("rainbowStriped")'
                        ...
                        <div class='row'>
                            <div class='col-md-12'>
                                <h4>Configura&ccedil;&atilde;o</h4>
                                <div class='col-md-4'>
                                ...
                                <div class='col-md-2'>
                                    ...
                                    <input type='number' class='form-control' id='totalLeds' min='1' max='10' value='1'>
                                </div>
                                <div class='col-md-2'>
            ...
            <div class='row'>
                <div class='col-md-12'>
                    <span>
                        <h3>Controle de medi&ccedil;&atilde;o de temperatura/umidade</h3><span>
                            <table class='table'>
                                <thead>
                                    <tr>
                                        <th>Sensor</th>
                    ...
                    <div class='row'>
                        <div class='col-md-4'>
                            <h4 class='text-left'>LED
                                <span class='badge'>
                                    <td><span id='ledState'>NA</span></td>
                                </span>
                            </h4>
                        </div>
                        <div class='col-md-1'>
